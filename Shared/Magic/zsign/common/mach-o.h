...
#define MH_INCRLINK                                                                                                    \
    0x00000002 /* the object file is the output of an incremental link against a base file and can't be link edited    \
                  again */
#define MH_DYLDLINK                                                                                                    \
    0x00000004 /* the object file is input for the dynamic linker and can't be staticly link edited again */
#define MH_BINDATLOAD                                                                                                  \
    0x00000008                 /* the object file's undefined references are bound by the dynamic linker when loaded. */
...
#define SG_HIGHVM                                                                                                      \
    0x00000001 /* the file contents for this segment is for                                                            \
  the high part of the VM space, the low part                                                                          \
  is zero filled (for stacks in core files) */
#define SG_FVMLIB                                                                                                      \
    0x00000002 /* this segment is the VM that is allocated by                                                          \
  a fixed VM library, for overlap checking in                                                                          \
  the link editor */
#define SG_NORELOC                                                                                                     \
    0x00000004                            /* this segment has nothing that was relocated                               \
